 ...
 * @version 2/2/2016 Developed for CPE 103 Lab07 
 */
package Lab8;
...
public class BSTStudentAcceptanceTests {
   ...
   public void test03_verifyFields() throws NoSuchFieldException { // points = 5
   ...
   @Test
   @TestDescription(desc="Verify 9 public methods in BST")
   ...
   public void test01_containsAtConstruction() { // points = 5 
   ...
   public void test02_toSortedListAtConstruction() { // points = 5 
      BST<Integer> bst = new BST<Integer>();
   ...
   @TestDescription(desc="Insert values: {99, -4, 167, 139, 55, -89, 13, 78, 178, 174}.\n" + 
                         "Verify maximum")
   public void test05_maximum() { // points = 5 
      BST<Integer> bst = new BST<Integer>();
      int[] values = new int[] {99, -4, 167, 139, 55, -89, 13, 78, 178, 174};
   ...
   public void test08_insertBigOh() { // points = 5 
      for (int i = 0; i < globalSize; i++) {
   ...
   public void test09_containsBigOh() { // points = 5 
      for (int i = 0; i < globalSize; i++) {
   ...
   public void test10_containsBigOh2() { // points = 5 
   ...
   public void test11_minMaxBigOh() { // points = 5 
   ...
   public void test12_toSortedListBigOh() { // points = 5 
   ...
   public void test04_removeAtConstruction() // points = 5
   {
     BST<Integer> bst = new BST<Integer>();
     bst.remove(99);
   }
   ...
   public void test15_removeBSTOfOne() // points = 5
   {
     BST<Integer> bst = new BST<Integer>();
     bst.insert(99);
     bst.remove(99);
   ...
   public void test16_removeBSTOfTwoLeft() // points = 5
   {
      BST<Integer> bst = new BST<Integer>();
   ...
   public void test17_removeListOfTwoRight() // points = 5
   {
      BST<Integer> bst = new BST<Integer>();
   ...
   public void test19_removeAllLargeTree() // points = 5
   {
      BST<Integer> bst = new BST<Integer>();
   ...
   public void test22_treeHeightVariousGreaterThanOne() // points = 5
   {
      BST<Integer> bst = new BST<Integer>();
   ...
   public void test31_treeHeightBigOh() // points = 5
   {
      for (int i = 0; i < 10; i++)
   ...
   public void test32_internalPathLengthBigOh() // points = 5
   {
      for (int i = 0; i < 10; i++)
   ...
   public void test33_removeBigOh() // points = 5
   {
